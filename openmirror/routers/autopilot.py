...
from openmirror.agent.autopilot import AUTOPILOT_PROMPT, Run, autopilot, frames
    ...
    if not config.desktop_enabled:
        raise HTTPException(
            ...
            detail='autopilot drives the screen, and desktop control is off on this install. '
                   'Set OPENMIRROR_DESKTOP=true.',
        )

    from openmirror.routers.agent import _resolve_chat
