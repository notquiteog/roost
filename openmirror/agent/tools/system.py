...
platform decides what that means. See `openmirror/system.py` for the table.
...
from openmirror.system import Manager, Platform, detect, recipe_for, route_for
...
class DisplayInfoTool(_SystemTool):
    ...
    async def run(self, args: dict[str, Any], ctx: ToolContext) -> Output:
        from openmirror.agent.stage import monitors
        from openmirror.system import hdr_route
