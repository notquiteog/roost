...
from roost.providers.realtime import (
    SAMPLE_RATE,
    RealtimeConfig,
    RealtimeSession,
    RealtimeUnavailable,
...
AUTOPILOT_PROMPT = """You are Roost, in a spoken conversation with someone at their computer. \
...
async def realtime_socket(
    ...
    instructions = AUTOPILOT_PROMPT if agent is not None else (
        'You are Roost, having a spoken conversation. Speak the way a person would: short '
