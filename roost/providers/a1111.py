...
class A1111Provider(ImageProvider):
    ...
    async def describe(self, model: str = '') -> list[Param]:
        ...
        params += [
            ...
            Param('denoising_strength', 'Denoising strength', 'float', default=0.7, minimum=0.0,
                  maximum=1.0, step=0.01, group='quality', advanced=True,
                  help='How much the second pass may change. Above about 0.6 it starts '
                       'inventing rather than sharpening.'),
